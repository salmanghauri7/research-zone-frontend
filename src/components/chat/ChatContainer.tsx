              ...
              {Object.entries(groupedMessages).map(([date, msgs]) => (
                <div key={date}>
                  ...
                  <div className="flex items-center gap-4 px-6 py-4">
                    ...
                    <span className="text-xs font-medium px-3 py-1 rounded-full bg-slate-100 text-slate-500 dark:bg-white/4 dark:text-white/40">
                      {date}
                    </span>
                    <div className="flex-1 h-px bg-slate-200 dark:bg-white/6" />
                  </div>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 py-12">
      <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-5 bg-indigo-50 dark:bg-indigo-500/10">
        <svg
      ...
      <h3 className="text-lg font-semibold mb-1.5 text-slate-800 dark:text-white">
        Start the conversation
      </h3>
      <p className="text-center max-w-sm text-sm text-slate-500 dark:text-white/45">
